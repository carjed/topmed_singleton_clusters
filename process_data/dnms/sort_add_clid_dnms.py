...
# sourcedir + "topmed_freeze5_dnms/merged/anno/old/" + \
#-----------------------------------------------------------------------------
concatcmd = "cat " + \
    sourcedir + "decode_dnms/" + \
    chrom + ".*"
...
# topmed_freeze5_dnms/merged/anno/old_sorted/
# chrom + ".freeze5.dnms.sort.txt"

outfile = sourcedir + "decode_dnms/anno/" + \
